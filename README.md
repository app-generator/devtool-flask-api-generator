...
```
3. run `flask gen_api` to generate api codes.
   * if there is any model in the config that there isn't model class for it, a log will be printed.
4. enjoy (API Calls samples are same as django dynamic api project)
    * for example, you can:
...
**Authentication**
 ...
 ```
 {
    "Authorization": "b36705e1078b4b67d4dc4f1388a1aee4a754d4cd"
 }
 ```